        ...
        mounted() {
            ...
            layui.use('table', function(){
                ...
                table.render({
                    ...
                    url: 'api/user/Sys/v1/clients/simple' //后台springmvc接收路径
                    ...
                    reload: function(){
                        ...
                        if (demoReload.val()===""){
                            ...
                            table.reload('stuInfo', {
                                ...
                                url:'/api/user/Sys/v1/clients/ceName/'+" ",
                                method:'get'
                            });
                            ...
                            table.reload('stuInfo', {
                                ...
                                url:'/api/user/Sys/v1/clients/ceName/'+demoReload.val(),
                                // where: {
                                //     key: {
                                //         id: demoReload.val()
                                //     }
