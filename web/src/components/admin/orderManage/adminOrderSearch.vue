<template>
  <div>
    <div className="x-nav">
      <a className="layui-btn layui-btn-small" style="line-height:1.6em;margin-top:3px;float:right"
         href="javascript:location.replace(location.href);" title="刷新">
        <i className="layui-icon" style="line-height:30px">ဂ</i></a>
    </div>
  ...
  mounted() {
    ...
    layui.use(['table', 'form'], function () {
      ...
      table.render({
        ...
        , id: 'csInfo'
        , method: 'get'
        , url: 'api/order/Sys/v1/orders' //后台springmvc接收路径
